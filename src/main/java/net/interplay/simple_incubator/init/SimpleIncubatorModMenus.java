...
public class SimpleIncubatorModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<IncubationTransmitterGUIMenu>> INCUBATION_TRANSMITTER_GUI = REGISTRY.register("incubation_transmitter_gui", () -> IMenuTypeExtension.create(IncubationTransmitterGUIMenu::new));
}
